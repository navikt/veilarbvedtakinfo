...
@WebMvcTest(BehovsvurderingControllerV2.class)
public class BehovsvurderingControllerV2Test {
    ...
    public void kunne_oppretteOgOppdatere_besvarelse() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(post("/api/v2/behovsvurdering/besvarelse")
        ...
        mockMvc.perform(post("/api/v2/behovsvurdering/besvarelse")
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(objectMapper.writeValueAsString(
                        new NyttSvarRequest(
                                FNR_1,
