...
import no.nav.veilarbvedtakinfo.domain.motestotte.HentSisteBesvarelseRequest;
import no.nav.veilarbvedtakinfo.domain.motestotte.Motestotte;
import no.nav.veilarbvedtakinfo.domain.motestotte.NyttSvarRequest;
...
public class MotestotteControllerV2 {
    ...
    public ResponseEntity nyttSvar(@RequestBody NyttSvarRequest nyttSvarRequest) {
    ...
    public Motestotte hent(@RequestBody HentSisteBesvarelseRequest hentSisteBesvarelseRequest) {
